...
class SpreadSheetTests(unittest.TestCase):
    ...
    the class expects assignment of SERVER and PORT. Further, each test case
    ...
    def setUp(self):
        ...
        self.spreadsheet = SpreadSheetClient.SpreadSheetClient(
            SpreadSheetTests.SERVER, SpreadSheetTests.PORT)
...
def main(args: argparse.Namespace):
    SpreadSheetTests.SERVER = args.server
    SpreadSheetTests.PORT = args.port
